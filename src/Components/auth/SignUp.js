...
const SignUp = () => {
  ...
  const handleStep1Next = () => {
    ...
    navigate("/SignUp/Step2"); // go to next step
  };
  return (
        ...
        <div className="w-[90%] max-h-[95vh] overflow-y-auto bg-white/10 backdrop-blur-md border border-[#4addbf50] rounded-3xl p-10 shadow-[0_0_30px_#4addbf70] text-white">
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="text-right">
              ...
              <a
                href="/SignIn"
                className="text-[#4addbf] hover:underline text-lg"
              >
                Sign In
              </a>
            </div>
          ...
          <div className="mb-8 text-center">
            <h1 className="text-5xl font-bold mb-3">
              Welcome to <span className="text-[#4addbf]">Medlink</span>
            </h1>
          ...
          <form className="space-y-6">
            ...
            <div className="relative group">
              ...
              />
              {isFullNameValid && (
                <FiCheckCircle className="absolute right-4 top-4 text-[#4addbf]" />
              )}
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative group">
                ...
                >
                  {showPassword ? (
                    <FiEyeOff className="text-white/70" />
                  ) : (
                    <FiEye className="text-white/70" />
                  )}
                </button>
                {isPasswordValid && (
                  <FiCheckCircle className="absolute right-12 top-4 text-[#4addbf]" />
                )}
              </div>
              <div className="relative group">
                <FiLock className="absolute left-4 top-4 text-white/70 group-focus-within:text-[#4addbf]" />
            ...
            <div className="flex items-start space-x-3">
              <label className="relative inline-flex items-center cursor-pointer mt-1">
                ...
                <div className="w-6 h-6 bg-white/10 border-2 border-white/30 rounded-lg peer-checked:border-[#4addbf] peer-checked:bg-[#4addbf]/30 transition-all flex items-center justify-center">
                  <svg
                    className="w-4 h-4 text-[#4addbf] opacity-0 peer-checked:opacity-100"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth={2}
                    viewBox="0 0 24 24"
              ...
              <p className="text-white/80 text-sm leading-tight">
                I agree to the{" "}
                <a href="#" className="text-[#4addbf] underline">
                  Terms
                </a>
                ,{" "}
                <a href="#" className="text-[#4addbf] underline">
            ...
            <div className="flex justify-center pt-6">
              <button
                ...
                className={`w-64 py-4 rounded-2xl font-bold text-lg flex items-center justify-center gap-3 shadow-[0_0_40px_#4addbf70] transition-all ${
                  isFormComplete
