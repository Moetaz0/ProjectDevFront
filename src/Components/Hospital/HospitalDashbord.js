    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      <div className="flex">
        ...
        <aside className="w-64 bg-white border-r border-gray-200 min-h-screen p-6 hidden md:block">
          <div className="text-2xl font-semibold mb-6">MedLink Hospital</div>
        ...
        <main className="flex-1 p-6">
          ...
          <header className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Overview of patients, occupancy and operations
              </p>
            </div>
          ...
          <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
              ...
              <div className="mt-3">
                <div className="text-xs text-gray-400">ICU usage: 85%</div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-xs text-gray-500">Surgeries Today</div>
                  <div className="text-2xl font-semibold">
              ...
              <div className="mt-3">
                <div className="text-xs text-gray-400">Emergencies: 2</div>
              </div>
            </div>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-white rounded border border-gray-100 shadow-sm p-4">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-medium">Recent Admissions</h2>
